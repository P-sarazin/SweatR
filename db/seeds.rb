...
lola = Coach.create!({ name: 'Lola', specialty: dance, bio:"Lola is a professional dancer with a side passion for fitness. She is worth a follow for daily fitness and nutrition motivation, as well as specific workouts to get her ripped physique. She has proven that any goal is attainable if you chase after it.", avatar_picture:"https://res.cloudinary.com/dlevfhxyn/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,bo_5px_solid_red,b_rgb:262c35/v1590655559/SweatR/coaches/prof_5_yapvl7.jpg"})
...
coralie = Coach.create!({ name: 'Coralie', specialty: relaxation, bio: "Coralie is a qualified Yoga Alliance teacher which passion is to make people happier and healthier by introducing them to meditation, yoga and healthy nutrition,as well as training advice and instructions to healthy recipes.", avatar_picture:"https://res.cloudinary.com/dlevfhxyn/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,bo_5px_solid_red,b_rgb:262c35/v1590655559/SweatR/coaches/prof_8_lbhobx.jpg"})
loic = Coach.create!({ name: 'loic', specialty: relaxation, bio:"Loic has programs for everyone, regardless of gender, size, training goals, or targets. From personalized training plans, to food plans, to supplement guides, to online support, he has got you covered on your fitness journey." , avatar_picture:"https://res.cloudinary.com/dlevfhxyn/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,bo_5px_solid_red,b_rgb:262c35/v1590655559/SweatR/coaches/prof_7_gsz0pf.jpg"})
