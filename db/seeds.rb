...
#specialties
#cardio_training/Crossfit (High Intensity Interval Training)
cardio_training = Specialty.create!({ name: 'Cardio Training' })
...
#user
axel = User.create!(name: 'David', email: "axel@gmail.com", password: "Axel!!")
axel.avatar_picture = "https://res.cloudinary.com/dlevfhxyn/image/upload/v1589893760/DAMIDHOME/Avatar/axel.png"
axel.save!

josephine = User.create!(name: 'Joséphine', email: "josephine@gmail.com", password: "Josephine!!")
josephine.avatar_picture = "https://res.cloudinary.com/dlevfhxyn/image/upload/v1589896478/DAMIDHOME/Avatar/josephine.png"
josephine.save!

pierre = User.create!(name: 'Pierre', email: "pierre@gmail.com", password: "Pierre!!")
pierre.avatar_picture = "https://res.cloudinary.com/dlevfhxyn/image/upload/v1589893760/DAMIDHOME/Avatar/pierre.png"
pierre.save!

marie = User.create!(name: 'Marie', email: "marie@gmail.com", password: "Marie!!")
marie.avatar_picture = "https://res.cloudinary.com/dlevfhxyn/image/upload/v1589893760/DAMIDHOME/Avatar/marie.png"
marie.save!

stan = User.create!(name: 'Stan', email: "stan@gmail.com", password: "Stan!!")
stan.avatar_picture = "https://res.cloudinary.com/dlevfhxyn/image/upload/v1589980952/DAMIDHOME/Avatar/stan.png"
stan.save!

jeanne = User.create!(name: 'Jeanne', email: "jeanne@gmail.com", password: "Jeanne!!")
jeanne.avatar_picture = "https://res.cloudinary.com/dlevfhxyn/image/upload/v1589981742/DAMIDHOME/Avatar/jeanne.png"
jeanne.save!

claire = User.create!(name: 'Claire', email: "claire@gmail.com", password: "Claire!!")
claire.avatar_picture = "https://res.cloudinary.com/dlevfhxyn/image/upload/v1589980951/DAMIDHOME/Avatar/claire.png"
claire.save!

laurence = User.create!(name: 'Laurence', email: "laurence@gmail.com", password: "Laurence!!")
laurence.avatar_picture = "https://res.cloudinary.com/dlevfhxyn/image/upload/v1589980952/DAMIDHOME/Avatar/laurence.png"
laurence.save!

alexandra = User.create!(name: 'Alexandra', email: "alexandra@gmail.com", password: "Alexandra!!")
alexandra.avatar_picture = "https://res.cloudinary.com/dlevfhxyn/image/upload/v1590156234/DAMIDHOME/Avatar/alexandra.png"
alexandra.save!

emile = User.create!(name: 'Emile', email: "emile@gmail.com", password: "Emile!!")
emile.avatar_picture = "https://res.cloudinary.com/dlevfhxyn/image/upload/v1590156235/DAMIDHOME/Avatar/emile.png"
emile.save!

puts "Creating coaches..."

#coach
remi = Coach.create!({ name: 'Rémi', specialty: cardio_training, bio:"Remi is a dedicated bodybuilding and physique master. His aesthetics are unprecedented! He is also a motivational speaker and a fulfilling coach who has helped so many on their journey to reaching their ideal physique.", avatar_picture:"https://res.cloudinary.com/dlevfhxyn/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,bo_5px_solid_red,b_rgb:262c35/v1590655559/SweatR/coaches/prof_4_mxc0as.jpg", model_lesson:"If you want to get stronger, let's cut out all the nonsense that doesn't matter and get right to the heart of what really does. 1. Start Every Training Session with an Explosive Lift or Jump Variation. 2. Train Movements, but Don't Neglect Building the Musculature. 3. Train More. 4. Get Freaky Strong on Single-Leg Exercises. For sure it will work !" })
david = Coach.create!({ name: 'David', specialty: cardio_training, bio:"David is a software engineer and bodybuilder and also one of the best trainers out there – even celebs trust this guy with their fitness. His success stories are unbeatable, and all credited to his online personalised fitness plans.", avatar_picture:"https://res.cloudinary.com/dlevfhxyn/image/upload/w_1000,c_fill,ar_1:1,g_auto,r_max,bo_5px_solid_red,b_rgb:262c35/v1591343915/SweatR/coaches/IMG_20200605_084727_vewyth.jpg", model_lesson:"If you want to get stronger, let's cut out all the nonsense that doesn't matter and get right to the heart of what really does. 1. Start Every Training Session with an Explosive Lift or Jump Variation. 2. Train Movements, but Don't Neglect Building the Musculature. 3. Train More. 4. Get Freaky Strong on Single-Leg Exercises. For sure it will work !" })
jp = Coach.create!({ name: 'JP', specialty: cardio_training, bio:"JP is a bodybuilding guru who is also an entrepreneur, motivational speaker, and cover model. From personalized training plans, to food plans, to supplement guides, to online support, he has got you covered on your fitness journey." ,avatar_picture:"https://res.cloudinary.com/dlevfhxyn/image/upload/v1590655560/SweatR/coaches/prof_6_kulmre.jpg", model_lesson:"If you want to get stronger, let's cut out all the nonsense that doesn't matter and get right to the heart of what really does. 1. Start Every Training Session with an Explosive Lift or Jump Variation. 2. Train Movements, but Don't Neglect Building the Musculature. 3. Train More. 4. Get Freaky Strong on Single-Leg Exercises. For sure it will work !"})
coach_cardio_training = [remi, david, jp]
...
5.times do
  lesson = Lesson.where("appointment < ?", Time.now).sample
  Booking.create!({ review_text: "", review_rating: nil, lesson: lesson, user: pierre })
end

#attribute reviews to past bookings
Booking.joins(:lesson).where("lessons.appointment < ?", Time.now).each do |past_booking|
  random_rating = [3, 4, 5].sample
  past_booking.review_rating = random_rating
  past_booking.save
end
